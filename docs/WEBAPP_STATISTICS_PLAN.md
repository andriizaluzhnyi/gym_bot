...
- **Одиниця серії — тиждень** (реалістично для 3–4 тренувань/тиждень).
  Якщо потрібна денна серія — змінюється лише `calculate_streak`.
- **Історія до GYM-2 відсутня в статистиці** (GYM-2b скасовано, див. Epic 0).
  Серія/PR/об'єм за Epic 1–4 стартують «з нуля» в момент розгортання GYM-2,
