...
логується. Окремо є **одноразовий бекфіл** історії з аркушів `Логи (*)`.
Аркуші `Програми (<user>)` не чіпаємо — Sheets лишається джерелом істини для
програм.
...
| ---- | ----- | -- | --------- |
| 0 | Фундамент: auth-декоратор, лог тренувань у БД, бекфіл | 15 | Must (блокує все інше) — GYM-0 ✅, GYM-1 ✅, GYM-2 ✅ |
